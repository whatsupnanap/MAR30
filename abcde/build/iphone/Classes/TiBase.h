...
// in simulator we redefine to format for abcde Developer console
...
{\
	NSString * exceptionName = [@"org.abcde." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.abcde";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIabcdeNativeItemNone = -1, 
	UIabcdeNativeItemSpinner = -2,
	UIabcdeNativeItemProgressBar = -3,
	
	UIabcdeNativeItemSlider = -4,
	UIabcdeNativeItemSwitch = -5,
	UIabcdeNativeItemMultiButton = -6,
	UIabcdeNativeItemSegmented = -7,
	
	UIabcdeNativeItemTextView = -8,
	UIabcdeNativeItemTextField = -9,
	UIabcdeNativeItemSearchBar = -10,
	
	UIabcdeNativeItemPicker = -11,
	UIabcdeNativeItemDatePicker = -12,
	
	UIabcdeNativeItemInfoLight = -13,
	UIabcdeNativeItemInfoDark = -14,
	
	UIabcdeNativeItemDisclosure = -15,
	
	UIabcdeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all abcde instances of
