...
@interface april2lectureObject : KrollCoverageObject {
#else
@interface april2lectureObject : KrollObject {
#endif
@private
...
extern NSString * april2lecture$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	april2lectureObject *_april2lecture;
    KrollObject* console;
	BOOL shutdown;
