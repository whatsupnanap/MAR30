...
//@interface april2lectureObject : NSObject
//@end

@interface april2lectureObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[april2lectureObject class]])
		{
			for (NSString *key in [[(april2lectureObject*)o modules] allKeys])
			{
