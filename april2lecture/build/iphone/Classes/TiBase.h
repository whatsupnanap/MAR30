...
// in simulator we redefine to format for april2lecture Developer console
...
{\
	NSString * exceptionName = [@"org.april2lecture." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.april2lecture";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIapril2lectureNativeItemNone = -1, 
	UIapril2lectureNativeItemSpinner = -2,
	UIapril2lectureNativeItemProgressBar = -3,
	
	UIapril2lectureNativeItemSlider = -4,
	UIapril2lectureNativeItemSwitch = -5,
	UIapril2lectureNativeItemMultiButton = -6,
	UIapril2lectureNativeItemSegmented = -7,
	
	UIapril2lectureNativeItemTextView = -8,
	UIapril2lectureNativeItemTextField = -9,
	UIapril2lectureNativeItemSearchBar = -10,
	
	UIapril2lectureNativeItemPicker = -11,
	UIapril2lectureNativeItemDatePicker = -12,
	
	UIapril2lectureNativeItemInfoLight = -13,
	UIapril2lectureNativeItemInfoDark = -14,
	
	UIapril2lectureNativeItemDisclosure = -15,
	
	UIapril2lectureNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all april2lecture instances of
