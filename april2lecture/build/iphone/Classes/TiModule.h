...
/**
 The base class for all april2lecture modules
 */
...
/**
 april2lecture Platform calls this method on startup.
 */
-(void)startup;

/**
 april2lecture Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 april2lecture Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 april2lecture Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 april2lecture Platform calls this method on resume.
 @param sender The sender of the event.
 */
