...
//Rare exceptions to indicate a bug in the _april2lecture code (Eg, function that a subclass should have implemented)
...
/**
 The base class for april2lecture proxies.
 */
