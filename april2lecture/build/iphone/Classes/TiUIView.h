...
/**
 Base class for all april2lecture views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the april2lecture view hierarchy (such as wrapped iOS UIViews) was touched.
