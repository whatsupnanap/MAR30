...
// in simulator we redefine to format for day4 Developer console
...
{\
	NSString * exceptionName = [@"org.day4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.day4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIday4NativeItemNone = -1, 
	UIday4NativeItemSpinner = -2,
	UIday4NativeItemProgressBar = -3,
	
	UIday4NativeItemSlider = -4,
	UIday4NativeItemSwitch = -5,
	UIday4NativeItemMultiButton = -6,
	UIday4NativeItemSegmented = -7,
	
	UIday4NativeItemTextView = -8,
	UIday4NativeItemTextField = -9,
	UIday4NativeItemSearchBar = -10,
	
	UIday4NativeItemPicker = -11,
	UIday4NativeItemDatePicker = -12,
	
	UIday4NativeItemInfoLight = -13,
	UIday4NativeItemInfoDark = -14,
	
	UIday4NativeItemDisclosure = -15,
	
	UIday4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all day4 instances of
