...
/**
 The base class for all day4 modules
 */
...
/**
 day4 Platform calls this method on startup.
 */
-(void)startup;

/**
 day4 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 day4 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 day4 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 day4 Platform calls this method on resume.
 @param sender The sender of the event.
 */
