...
@interface deviceDetectionObject : KrollCoverageObject {
#else
@interface deviceDetectionObject : KrollObject {
#endif
@private
...
extern NSString * deviceDetection$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	deviceDetectionObject *_devicedetection;
    KrollObject* console;
	BOOL shutdown;
