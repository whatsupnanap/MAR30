...
//@interface deviceDetectionObject : NSObject
//@end

@interface deviceDetectionObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[deviceDetectionObject class]])
		{
			for (NSString *key in [[(deviceDetectionObject*)o modules] allKeys])
			{
