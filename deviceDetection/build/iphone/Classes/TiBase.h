...
// in simulator we redefine to format for deviceDetection Developer console
...
{\
	NSString * exceptionName = [@"org.devicedetection." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.devicedetection";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIdeviceDetectionNativeItemNone = -1, 
	UIdeviceDetectionNativeItemSpinner = -2,
	UIdeviceDetectionNativeItemProgressBar = -3,
	
	UIdeviceDetectionNativeItemSlider = -4,
	UIdeviceDetectionNativeItemSwitch = -5,
	UIdeviceDetectionNativeItemMultiButton = -6,
	UIdeviceDetectionNativeItemSegmented = -7,
	
	UIdeviceDetectionNativeItemTextView = -8,
	UIdeviceDetectionNativeItemTextField = -9,
	UIdeviceDetectionNativeItemSearchBar = -10,
	
	UIdeviceDetectionNativeItemPicker = -11,
	UIdeviceDetectionNativeItemDatePicker = -12,
	
	UIdeviceDetectionNativeItemInfoLight = -13,
	UIdeviceDetectionNativeItemInfoDark = -14,
	
	UIdeviceDetectionNativeItemDisclosure = -15,
	
	UIdeviceDetectionNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all deviceDetection instances of
