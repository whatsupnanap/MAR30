...
//Rare exceptions to indicate a bug in the _devicedetection code (Eg, function that a subclass should have implemented)
...
/**
 The base class for deviceDetection proxies.
 */
