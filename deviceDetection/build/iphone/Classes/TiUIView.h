...
/**
 Base class for all deviceDetection views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the deviceDetection view hierarchy (such as wrapped iOS UIViews) was touched.
