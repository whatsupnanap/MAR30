...
// in simulator we redefine to format for game Developer console
...
{\
	NSString * exceptionName = [@"org.game." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.game";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIgameNativeItemNone = -1, 
	UIgameNativeItemSpinner = -2,
	UIgameNativeItemProgressBar = -3,
	
	UIgameNativeItemSlider = -4,
	UIgameNativeItemSwitch = -5,
	UIgameNativeItemMultiButton = -6,
	UIgameNativeItemSegmented = -7,
	
	UIgameNativeItemTextView = -8,
	UIgameNativeItemTextField = -9,
	UIgameNativeItemSearchBar = -10,
	
	UIgameNativeItemPicker = -11,
	UIgameNativeItemDatePicker = -12,
	
	UIgameNativeItemInfoLight = -13,
	UIgameNativeItemInfoDark = -14,
	
	UIgameNativeItemDisclosure = -15,
	
	UIgameNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all game instances of
