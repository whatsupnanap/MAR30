...
//@interface requireObject : NSObject
//@end

@interface requireObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[requireObject class]])
		{
			for (NSString *key in [[(requireObject*)o modules] allKeys])
			{
