...
// in simulator we redefine to format for require Developer console
...
{\
	NSString * exceptionName = [@"org.require." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.require";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIrequireNativeItemNone = -1, 
	UIrequireNativeItemSpinner = -2,
	UIrequireNativeItemProgressBar = -3,
	
	UIrequireNativeItemSlider = -4,
	UIrequireNativeItemSwitch = -5,
	UIrequireNativeItemMultiButton = -6,
	UIrequireNativeItemSegmented = -7,
	
	UIrequireNativeItemTextView = -8,
	UIrequireNativeItemTextField = -9,
	UIrequireNativeItemSearchBar = -10,
	
	UIrequireNativeItemPicker = -11,
	UIrequireNativeItemDatePicker = -12,
	
	UIrequireNativeItemInfoLight = -13,
	UIrequireNativeItemInfoDark = -14,
	
	UIrequireNativeItemDisclosure = -15,
	
	UIrequireNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all require instances of
