...
@interface tanaka_nana_projec1Object : KrollCoverageObject {
#else
@interface tanaka_nana_projec1Object : KrollObject {
#endif
@private
...
extern NSString * tanaka_nana_projec1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	tanaka_nana_projec1Object *_tanaka_nana_projec1;
    KrollObject* console;
	BOOL shutdown;
