...
//@interface tanaka_nana_projec1Object : NSObject
//@end

@interface tanaka_nana_projec1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[tanaka_nana_projec1Object class]])
		{
			for (NSString *key in [[(tanaka_nana_projec1Object*)o modules] allKeys])
			{
