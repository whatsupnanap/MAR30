...
// in simulator we redefine to format for tanaka_nana_projec1 Developer console
...
{\
	NSString * exceptionName = [@"org.tanaka_nana_projec1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tanaka_nana_projec1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UItanaka_nana_projec1NativeItemNone = -1, 
	UItanaka_nana_projec1NativeItemSpinner = -2,
	UItanaka_nana_projec1NativeItemProgressBar = -3,
	
	UItanaka_nana_projec1NativeItemSlider = -4,
	UItanaka_nana_projec1NativeItemSwitch = -5,
	UItanaka_nana_projec1NativeItemMultiButton = -6,
	UItanaka_nana_projec1NativeItemSegmented = -7,
	
	UItanaka_nana_projec1NativeItemTextView = -8,
	UItanaka_nana_projec1NativeItemTextField = -9,
	UItanaka_nana_projec1NativeItemSearchBar = -10,
	
	UItanaka_nana_projec1NativeItemPicker = -11,
	UItanaka_nana_projec1NativeItemDatePicker = -12,
	
	UItanaka_nana_projec1NativeItemInfoLight = -13,
	UItanaka_nana_projec1NativeItemInfoDark = -14,
	
	UItanaka_nana_projec1NativeItemDisclosure = -15,
	
	UItanaka_nana_projec1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all tanaka_nana_projec1 instances of
