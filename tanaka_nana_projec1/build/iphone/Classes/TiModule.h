...
/**
 The base class for all tanaka_nana_projec1 modules
 */
...
/**
 tanaka_nana_projec1 Platform calls this method on startup.
 */
-(void)startup;

/**
 tanaka_nana_projec1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 tanaka_nana_projec1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 tanaka_nana_projec1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 tanaka_nana_projec1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
