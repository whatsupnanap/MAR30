...
//Rare exceptions to indicate a bug in the _tanaka_nana_projec1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for tanaka_nana_projec1 proxies.
 */
