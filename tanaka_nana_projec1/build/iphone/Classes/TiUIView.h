...
/**
 Base class for all tanaka_nana_projec1 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the tanaka_nana_projec1 view hierarchy (such as wrapped iOS UIViews) was touched.
