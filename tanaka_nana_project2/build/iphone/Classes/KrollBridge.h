...
@interface tanaka_nana_project2Object : KrollCoverageObject {
#else
@interface tanaka_nana_project2Object : KrollObject {
#endif
@private
...
extern NSString * tanaka_nana_project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	tanaka_nana_project2Object *_tanaka_nana_project2;
    KrollObject* console;
	BOOL shutdown;
