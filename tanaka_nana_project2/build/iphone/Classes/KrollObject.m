...
//@interface tanaka_nana_project2Object : NSObject
//@end

@interface tanaka_nana_project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[tanaka_nana_project2Object class]])
		{
			for (NSString *key in [[(tanaka_nana_project2Object*)o modules] allKeys])
			{
