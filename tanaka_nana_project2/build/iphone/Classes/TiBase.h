...
// in simulator we redefine to format for tanaka_nana_project2 Developer console
...
{\
	NSString * exceptionName = [@"org.tanaka_nana_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tanaka_nana_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UItanaka_nana_project2NativeItemNone = -1, 
	UItanaka_nana_project2NativeItemSpinner = -2,
	UItanaka_nana_project2NativeItemProgressBar = -3,
	
	UItanaka_nana_project2NativeItemSlider = -4,
	UItanaka_nana_project2NativeItemSwitch = -5,
	UItanaka_nana_project2NativeItemMultiButton = -6,
	UItanaka_nana_project2NativeItemSegmented = -7,
	
	UItanaka_nana_project2NativeItemTextView = -8,
	UItanaka_nana_project2NativeItemTextField = -9,
	UItanaka_nana_project2NativeItemSearchBar = -10,
	
	UItanaka_nana_project2NativeItemPicker = -11,
	UItanaka_nana_project2NativeItemDatePicker = -12,
	
	UItanaka_nana_project2NativeItemInfoLight = -13,
	UItanaka_nana_project2NativeItemInfoDark = -14,
	
	UItanaka_nana_project2NativeItemDisclosure = -15,
	
	UItanaka_nana_project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all tanaka_nana_project2 instances of
