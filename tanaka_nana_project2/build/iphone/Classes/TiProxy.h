...
//Rare exceptions to indicate a bug in the _tanaka_nana_project2 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for tanaka_nana_project2 proxies.
 */
