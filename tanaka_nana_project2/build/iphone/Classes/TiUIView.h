...
/**
 Base class for all tanaka_nana_project2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the tanaka_nana_project2 view hierarchy (such as wrapped iOS UIViews) was touched.
